...
const useActivation = (
  ...
  const API_URL = transactionId
    ? `${process.env.REACT_APP_API_URL}/admin/activation/${transactionId}`
    : `${
        process.env.REACT_APP_API_URL
      }/admin/activation?page=${page}&limit=${limit}&search=${searchTerm}&user=${
        userId || ''
      }`;
  ...
  }, [transactionId, userId, page, limit, searchTerm]);
